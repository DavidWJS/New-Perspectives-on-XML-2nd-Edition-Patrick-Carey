        ...
        <html>
            ...
            <body>
                 ...
                 <table border="1">
                    ...
                    <xsl:for-each select="animals/type">
                        ...
                        <tr>
                            ...
                            <td><xsl:apply-templates select="trait"/></td>
                ...
                <table border="1">
                    ...
                    <xsl:apply-templates select="animals/type[contains(trait, 'Endothermic')]"/>
                </table>
                <p/>
                <hr/>
                4. How many cold-blooded animals:
                <xsl:value-of select="count(animals/type[contains(trait, 'Cold-blooded')]/animal)"/>
                <p/>
                <hr/>
